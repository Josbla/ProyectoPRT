<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <ul class="navbar-nav mr-auto">
        <li class="nav-item active font-weight-bold">
            <a class="nav-link" href="#"><i class="fas fa-users-cog"></i> Administración de funcionarios <span class="sr-only">(current)</span></a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="./Plantas"><i class="fas fa-building"></i> Administración de plantas</a>
        </li>
