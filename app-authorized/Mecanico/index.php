    ...
    <section>
        <div class="container py-5"  ng-app="appAuth">
            ...
            <div class="row">
                ...
                <div class="card">
                    <div class="card-body">
                    <a class="btn btn-light btn-lg light" href="./alineacion"><i class="fas fa-car"></i> Alineación</a>
                    </div>
                </div>
                ...
                <div class= "col-6">
                    ...
                    <div class="card bg-info text-white">
                        <div class="card-body">
                            <a class="btn btn-info btn-lg light" href="./sistemasuspension"><i class="fas fa-syringe"></i> Suspensión</a>
                        </div>
                    </div> 
